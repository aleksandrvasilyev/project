...
export const API_EVENTS_URL = `https://www.jambase.com/jb-api/v1/events?geoLatitude=latitude_value&geoLongitude=longitude_value&eventDateFrom=start_date&eventDateTo=end_date&eventDataSource=ticketmaster&apikey=api_key_value&perPage=8&page=page_number`;
